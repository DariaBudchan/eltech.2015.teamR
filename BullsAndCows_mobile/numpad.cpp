...
{
    int min = this->width()/3-6;
    if(flag){
        btn_1->setMaximumSize(min,min);
        btn_1->setMinimumSize(min,min);

        btn_2->setMaximumSize(min,min);
        btn_2->setMinimumSize(min,min);

        btn_3->setMaximumSize(min,min);
        btn_3->setMinimumSize(min,min);

        btn_4->setMaximumSize(min,min);
        btn_4->setMinimumSize(min,min);

        btn_5->setMaximumSize(min,min);
        btn_5->setMinimumSize(min,min);

        btn_6->setMaximumSize(min,min);
        btn_6->setMinimumSize(min,min);

        btn_7->setMaximumSize(min,min);
        btn_7->setMinimumSize(min,min);

        btn_8->setMaximumSize(min,min);
        btn_8->setMinimumSize(min,min);

        btn_9->setMaximumSize(min,min);
        btn_9->setMinimumSize(min,min);
        flag = false;
    }
    QPainter p(this);
...
NumPad::NumPad(QWidget *parent) : QWidget(parent)
{
    ...
    btn_1 = new CustomPushButton(this);
    ...
    btn_2 = new CustomPushButton(this);
    ...
    btn_3 = new CustomPushButton(this);
    ...
    btn_4 = new CustomPushButton(this);
    ...
    btn_5 = new CustomPushButton(this);
    ...
    btn_6 = new CustomPushButton(this);
    ...
    btn_7 = new CustomPushButton(this);
    ...
    btn_8 = new CustomPushButton(this);
    ...
    btn_9 = new CustomPushButton(this);
